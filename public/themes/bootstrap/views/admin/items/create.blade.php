					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-4">
								<input type="hidden" id="tags" name="tags" class="form-control select2" value="" data-required="1">
							</div>
						</div>
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-4">
								<input type="hidden" id="category_id" name="category_id" class="form-control select2" value="" data-required="1">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-4">
								<select class="form-control select2me" name="language" id="selectLanguage" aria-required="true">

	...
	<div class="col-md-12">
		<div class="portlet light">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="users/create" class="btn btn-default btn-circle">
					<i class="fa fa-plus"></i>
					<span class="hidden-480">
					{{ucwords(Lang::get('admin.new').' '.Lang::get('admin.user'))}} </span>
					</a>
				</div>
			</div>
...
<script>
	var ajax_url = "/admin/users/ajax_table"
	var actions_url = "/admin/users/actions"

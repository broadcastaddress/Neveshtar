					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-8">
								<input type="text" name="email" value="{{old('email')}}" data-required="1" class="form-control" required/>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" name="google_plus" value="{{old('google_plus')}}" class="form-control"/>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="control-label col-md-3">{{Lang::get('admin.password')}} <span class="required">
							* </span>
							</label>
							<div class="col-md-8">
								<input type="password" name="password" value="{{old('password')}}" data-required="1" class="form-control" required/>
							</div>
						</div>
						<div class="form-group">

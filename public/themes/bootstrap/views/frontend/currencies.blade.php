      ...
      <div class="container">
			...
			<div class="portlet">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-dollar"></i> {{Lang::get('currency.currency_rates')}}
					</div>
				</div>
				<div class="portlet-body">
					...
					<table class="table table-striped table-advance table-hover">
						...
						<tr>
							<td class="highlight">
							<a href="/{{Lang::getLocale()}}/currencies/{{$currency->slug}}">
			...
			<div class="col-md-5 col-sm-12">
				...
				<div class="portlet bg-inverse light">
					<div class="portlet-title">
						<div class="caption">
							...
							<img src="/themes/bootstrap/assets/global/img/flags/us.png">
							{{Lang::get('currency.rate')}} {{Lang::get('currency.rial')}} {{Lang::get('currency.with')}} {{Lang::get('currency.dollar')}}
							</span>
						</div>
						<div class="actions">
					...
					<div class="portlet-body">
						<div id="chartdiv" class="amcharts-homepage">
						</div>
					</div>
				</div>
				<!-- END Portlet PORTLET-->
				...
				<div class="portlet bg-inverse light">
					<div class="portlet-title">
						<div class="caption">
							<span class="caption-subject bold uppercase">
							<img src="/themes/bootstrap/assets/global/img/flags/europeanunion.png">
							{{Lang::get('currency.rate')}} {{Lang::get('currency.rial')}} {{Lang::get('currency.with')}} {{Lang::get('currency.euro')}}
							</span>
						</div>
						<div class="actions">
							<a href="javascript:;" class="btn btn-circle btn-default btn-icon-only fullscreen"></a>
					...
					<div class="portlet-body">
						<div id="chartdiv2" class="amcharts-homepage">
						</div>
					</div>
				</div>
				<!-- END Portlet PORTLET-->
				...
				<div class="portlet bg-inverse light">
					<div class="portlet-title">
						<div class="caption">
							<span class="caption-subject bold uppercase">
							<img src="/themes/bootstrap/assets/global/img/flags/gb.png">
							{{Lang::get('currency.rate')}} {{Lang::get('currency.rial')}} {{Lang::get('currency.with')}} {{Lang::get('currency.pound')}}
							</span>
						</div>
						<div class="actions">
							<a href="javascript:;" class="btn btn-circle btn-default btn-icon-only fullscreen"></a>
					...
					<div class="portlet-body">
						<div id="chartdiv3" class="amcharts-homepage">
						</div>
					</div>
				</div>
				<!-- END Portlet PORTLET-->
...
var chart = AmCharts.makeChart("chartdiv", {
	...
	"dataLoader": {
		"url": "/{{Lang::getLocale()}}/ccharts/1/20",
		"format": "json"
	},
    "valueAxes": [{
    	"id": "v1",
        ...
        "guides": [{
            "dashLength": 6,
            "inside": true,
            "label": "{{Lang::get('currency.sell_average')}} - {{number_format($dollar_sell_median,0,'.',',')}}",
            "lineAlpha": 1,
            "value": {{$dollar_sell_median}},
        },{
            "dashLength": 6,
            "inside": true,
            "label": "{{Lang::get('currency.buy_average')}} - {{number_format($dollar_buy_median,0,'.',',')}}",
            "lineAlpha": 1,
            "value": {{$dollar_buy_median}},
        }],
    },{
    	"id": "v2",
        "position": "left",
...
var chart = AmCharts.makeChart("chartdiv2", {
    ...
    "pathToImages": "/themes/bootstrap/assets/global/plugins/amcharts/amcharts/images/",
	"dataLoader": {
		"url": "/{{Lang::getLocale()}}/ccharts/2/20",
		"format": "json"
	},
    "valueAxes": [{
    	"id": "v3",
        ...
        "guides": [{
            "dashLength": 6,
            "inside": true,
            "label": "{{Lang::get('currency.sell_average')}} - {{number_format($euro_sell_median,0,'.',',')}}",
            "lineAlpha": 1,
            "value": {{$euro_sell_median}},
        },{
            "dashLength": 6,
            "inside": true,
            "label": "{{Lang::get('currency.buy_average')}} - {{number_format($euro_buy_median,0,'.',',')}}",
            "lineAlpha": 1,
            "value": {{$euro_buy_median}},
        }],
    },{
    	"id": "v4",
        "position": "left",
...
var chart = AmCharts.makeChart("chartdiv3", {
    ...
    "pathToImages": "/themes/bootstrap/assets/global/plugins/amcharts/amcharts/images/",
	"dataLoader": {
		"url": "/{{Lang::getLocale()}}/ccharts/3/20",
		"format": "json"
	},
    "valueAxes": [{
    	"id": "v3",
        ...
        "guides": [{
            "dashLength": 6,
            "inside": true,
            "label": "{{Lang::get('currency.sell_average')}} - {{number_format($pound_sell_median,0,'.',',')}}",
            "lineAlpha": 1,
            "value": {{$pound_sell_median}},
        },{
            "dashLength": 6,
            "inside": true,
            "label": "{{Lang::get('currency.buy_average')}} - {{number_format($pound_buy_median,0,'.',',')}}",
            "lineAlpha": 1,
            "value": {{$pound_buy_median}},
        }],
    },{
    	"id": "v4",
        "position": "left",
...
function zoomChart() {
    chart.zoomToIndexes(chartData.length, chartData.length);
}
zoomChart();

	            ...
	            @endif
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8">
                      <h2><a href="/categoryItem">Corrupti quos dolores etquas</a></h2>
                      <ul class="blog-info">
                  ...
                  <div class="row">
                    <div class="col-md-4 col-sm-4">
                      <img class="img-responsive" alt="" src="/themes/bootstrap/assets/frontend/pages/img/works/img4.jpg">
                    </div>
                    <div class="col-md-8 col-sm-8">
                  ...
                  <div class="row">
                    <div class="col-md-4 col-sm-4">
                      <img class="img-responsive" alt="" src="/themes/bootstrap/assets/frontend/pages/img/works/img2.jpg">
                    </div>
                    <div class="col-md-8 col-sm-8">
